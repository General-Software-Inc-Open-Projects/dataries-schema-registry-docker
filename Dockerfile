...
ENV SCHEMA_REGISTRY_JAR=curl -O https://maven.pkg.github.com/general-software-inc-open-projects/dataries-schema-registry-connector/net/gsi/components/dataries-schema-registry-connector/1.0.0/dataries-schema-registry-connector-1.0.0.jar
